...
* Leading the [PowerPC/AIX](http://openjdk.java.net/projects/ppc-aix-port/) porting project and actively supporting the [JDK update projects](https://wiki.openjdk.java.net/display/JDKUpdates).

* Contributing as many of our features as possible to the upstream project and keep the diff of this project as small as possible.
